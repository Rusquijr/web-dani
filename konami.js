document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "about-text": "Hola, soy Daniel. Administrador de Sistemas de TI en UQUIFA y estudiante de Ingeniería Informática en la UOC. Soy un profesional proactivo con una base técnica sólida, actualmente enfocado en compaginar mi rol profesional con la formación universitaria para perfeccionar mis capacidades analíticas y tecnológicas. Mi trayectoria me ha permitido evolucionar desde el soporte técnico hasta la gestión de infraestructuras críticas, desarrollando una mentalidad resolutiva y una insaciable voluntad de aprendizaje.",
        ...
        en: {
            ...
            "about-text": "Hi, I'm Daniel. IT Systems Administrator at UQUIFA and Computer Engineering student at UOC. I am a proactive professional with a solid technical foundation, currently focused on balancing my professional role with university studies to refine my analytical and technological skills. My career has allowed me to evolve from technical support to managing critical infrastructure, developing a problem-solving mindset and an insatiable will to learn.",
        ...
        ca: {
            ...
            "about-text": "Hola, sóc en Daniel. Administrador de Sistemes de TI a UQUIFA i estudiant d'Enginyeria Informàtica a la UOC. Sóc un professional proactiu amb una base tècnica sòlida, actualment enfocat a compaginar el meu rol professional amb la formació universitària per perfeccionar les meves capacitats analítiques i tecnològiques. La meva trajectòria m'ha permès evolucionar des del suport tècnic fins a la gestió d'infraestructures crítiques, desenvolupant una mentalitat resolutiva i una insaciable voluntat d'aprenentatge.",
